...
public class BCryptPasswordEncoderTest {
	public static void main(String[] args) {
		...
		if (encoder.matches("abel",
				"$2a$10$IAz6WzJ314LH1NXq7Rf.dOYPP2uvzk08g.eAl9l4DRG4YsxavEV4W")) {
		...
		if (encoder.matches(Md5Password,
				"$2a$10$37MXEfzlbtC6QSsRTlRhIOmykMRJtO5mU8Y.yiJBjy1x4WYWFR5gG")) {
